...
from nn.compress_loss import CompReSSA, Teacher
...
def get_teacher_model(opt):
    ...
    if opt.cache_teacher:
        ...
        msg = model_t.load_state_dict(checkpoint['state_dict'], strict=False)
...
def main():
    ...
    student.fc = nn.Linear(student_feats_dim, teacher_feats_dim)

    compress = CompReSSA(teacher_feats_dim, args.compress_memory_size, args.compress_t)
